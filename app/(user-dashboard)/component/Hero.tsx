...
export default function Hero() {
  ...
  return (
    <div className="font-sans px-3 sm:px-4 md:px-6 mt-20 md:mt-6">

      {/* Stats */}
      <section className="mb-12">
        <h1 className="font-bold text-xl sm:text-2xl mb-3">Dashboard</h1>
        <p className="text-gray-500 mb-6 sm:mb-10 text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {stats.map((s, i) => (
            <div key={i} className="shadow-sm shadow-gray-300 rounded-md p-3">
              ...
              <h1 className="font-bold text-xl sm:text-2xl">{s.heading}</h1>
              <p className="text-sm">
      ...
      <section className="flex flex-col lg:flex-row gap-6 sm:gap-8 mb-8">
        ...
        {/* Quick Actions */}
        <div className="flex-1 rounded-md shadow shadow-gray-300 px-4 sm:px-6 py-6 sm:py-8">
          <h1 className="text-xl sm:text-2xl font-semibold mb-2">Quick Actions</h1>
      ...
      {/* Recent Activity */}
      <section className="border border-gray-300 rounded-md px-4 sm:px-6 py-4 sm:py-6">
        <h1 className="font-bold text-xl sm:text-2xl mb-2">Recent Activity</h1>
