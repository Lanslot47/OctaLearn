    ...
    <div>
      ...
      <div className="flex mb-8">
        <button
          ...
          className=" py-2 px-3   bg-blue-500 flex items-center ml-193 text-xl rounded-md text-white ">
      ...
      {clicked && (
        <div className="fixed inset-0 bg-black/60   z-50">
          <div className="w-149 mx-4 my-16 p-4 h-110 bg-white rounded-xl ml-87   shadow shadow-md-gray-500">
            <nav>
            ...
            <span className="flex items-center">
              ...
              <button
                className="hover hover:text-blue-500  cursor-pointer"
