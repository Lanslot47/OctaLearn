    ...
    <div>
      ...
      <div className="flex mb-8">
        <button
          ...
          className=" py-2 px-3 m  bg-blue-500 flex items-center ml-273 text-xl rounded-md text-white ">
      ...
      {clicked && (
        <div className="fixed inset-0 bg-black/60   z-50">
          <div className="w-149 mx-4 my-16 p-4 h-110 bg-gray-400 rounded-xl ml-87   shadow shadow-md-gray-500">
            <nav>
              <h1 className="font-semibold mb-2 ml-3">Create New Note</h1>
              <p className="text-sm mb-2 text-gray-500 ml-3">
                Create a new study note. You can export it to PDF later.
              </p>
            </nav>
            <input
              type="text"
              placeholder="Enter Note Title..."
              className="m-auto p-2 w-132 focus:outline-blue-500 rounded-md text-gray-500 border border-gray-300 mb-4 ml-4 text-sm"
            />
            <textarea
              placeholder="Tell others about yourself"
              className=" ml-4 border border-gray-300 hover:outline-blue-500 rounded-md w-135 h-62 p-2 mb-3"></textarea>
            <span className="flex items-center">
              ...
              <button
                className="hover hover:text-blue-500 -ml-155 cursor-pointer"
      ...
      <div>
        <section className="flex p-5  gap-18">
        ...
        <section>
          <div className="grid  grid-cols-3 gap-0  p-5 w-[80vw] space-y-8">
            <div className="border border-gray-300 h-72 w-67 rounded-md">
              <div className="px-5 py-8  ">
                <h1 className="font-semibold mb-3">
                  Physics Lab Report- <br /> pendulum...
                </h1>

                <p className="text-gray-400 mb-4">
                  Objective: to determinee accleration due to gravity using a
                  simple pendulmu.Metal bob - stopwacth-meter...
                </p>
                ...
                <div className="flex items-center mb-3">
                  ...
                  <button className="w-19 h-5 rounded-xl  border border-blue text-sm ml-15 ">
                    348 chars
                  </button>
                </div>
                <div>
            ...
            <div className="border border-gray-300 h-72 w-67 rounded-md">
              <div className="p-4 py-8">
                <h1 className="font-semibold mb-3">
                  {" "}
                  Data Structure- <br /> Binary Trees
                </h1>

                <p className="text-gray-400 mb-4">
                  Binary Trees Defination:A tree data structure where each node
                  has most two childern - leftsubTree value less than...{" "}
                </p>
                <div className="flex items-center mb-3">
                  <h1 className="flex items-center gap-1 text-gray-500 text-sm  ">
                    <IoCalendarOutline size={19} />
                  ...
                  <button className="w-19 h-5 rounded-xl  border border-gray-400 text-sm ml-15 ">
                    376 chars
                  </button>
                </div>
                <div>
