    ...
    return (
        <div className="py-12 px-4 sm:px-8">
            <form className="font-sans max-w-md sm:max-w-lg md:max-w-xl mx-auto bg-white">
                <h1 className="text-2xl sm:text-3xl text-center font-semibold">Admin Login</h1>
                <p className="text-sm sm:text-base mb-5 text-gray-500 text-center">
                    Sign in to manage the activities
                </p>
                <div className="space-y-2  mb-5">
                    <div className='ml-22'>
                        ...
                        <input
                            ...
                            className="w-110  p-2 focus:outline-blue-500 rounded-md text-gray-500 text-sm"
                        />
                    </div>
                    <div className='ml-8'>
                        ...
                        <input
                            ...
                            className="w-110 ml-14 p-2 focus:outline-blue-500 rounded-md text-gray-500 text-sm"
                        />
                    </div>
                </div>
